...
type Hero struct {
	Id         int       `orm:"column(id);auto" description:"id主键" json:"id"`
	Name       string    `orm:"column(name);size(20);null" description:"姓名" json:"name"`
	Type       int       `orm:"column(type);null" description:"类型" json:"type"`
	Skills     string    `orm:"column(skills);size(100);null" description:"技能" json:"skills"`
